...
This section includes a graph showing the vaccine coverage by week. 
...
This section includes a graph showing the vaccine coverage by week, divided by manifacturer. 
The data are also shown in the subsequent table. 
...
This section includes a graph showing the vaccine coverage by week, divided by dose number. 
The data are also shown in the subsequent table.
...
This section includes a graph showing the vaccine coverage by week, divided by manifacturer and by dose number. 
The data are also shown in the subsequent table.
