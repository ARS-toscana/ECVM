...
if(Vars_Form_Det){
    ...
    for(i in Cols){
      ...
      if(ColsFormat[form_iteration]=="continuous"){
        ...
        quantile_table=quantile(compDataset[,get(i)], probs = seq(0, 1, 0.25), na.rm = FALSE)
        variable_mean= mean(compDataset[,get(i)], na.rm=TRUE)
        variable_sd=sqrt(var(compDataset[,get(i)], na.rm=TRUE))
      ...
      if(ColsFormat[form_iteration]=="date"){
        ...
        date_table = c(min(compDataset[,get(i)]), max(compDataset[,get(i)]))
