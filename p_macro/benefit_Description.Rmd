...
######  dose 1 vs dose 2
BENEFIT_BIRTHCOHORTS_CALENDARTIME_4plt <- BENEFIT_BIRTHCOHORTS_CALENDARTIME[birth_cohort == "all_birth_cohorts" & vx_manufacturer == "Pfizer"  & COVID == "COVID"]
...
BENEFIT_BIRTHCOHORTS_TIMESINCEVACCINATION_4plot <- BENEFIT_BIRTHCOHORTS_TIMESINCEVACCINATION[birth_cohort == "all_birth_cohorts" & vx_manufacturer == "Pfizer"  & COVID == "COVID"]
