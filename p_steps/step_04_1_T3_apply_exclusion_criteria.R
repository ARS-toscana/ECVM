...
fwrite(get(paste0("Flowchart_basic_exclusion_criteria",suffix[[subpop]])), paste0(direxp,"Flowchart_basic_exclusion_criteria",suffix[[subpop]],"_",thisdatasource,"_",currentdate,"_",scriptversion,".csv"))
...
fwrite(get(paste0("Flowchart_exclusion_criteria",suffix[[subpop]])), paste0(direxp,"Flowchart_exclusion_criteria",suffix[[subpop]],"_",thisdatasource,"_",currentdate,"_",scriptversion,".csv"))
