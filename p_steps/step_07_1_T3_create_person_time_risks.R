...
# input: D4_study_population, D3_events_ALL_OUTCOMES.RData ,list_outcomes_observed.RData
...
# rm(list = nameobject)
rm(D4_study_population,persontime_risk_week,study_population,events_ALL_OUTCOMES)
