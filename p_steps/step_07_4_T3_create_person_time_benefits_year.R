...
for (subpop in subpopulations_non_empty) {  
  ...
  Output_file<-CountPersonTime(
    ...
    Strata = c("Dose","sex", "Birthcohort_persons","type_vax","week_fup", "CV", "COVCANCER", "COVCOPD", "COVHIV", "COVCKD",
...
for (subpop in subpopulations_non_empty){
  tempname<-paste0("D4_persontime_benefit_year",suffix[[subpop]],"_",thisdatasource,"_",currentdate,"_",scriptversion)
  thisdirexp <- ifelse(this_datasource_has_subpopulations == FALSE,direxp,direxpsubpop[[subpop]])
