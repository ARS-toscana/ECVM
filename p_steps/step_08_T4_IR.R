...
#D4_IR_benefit_week_BC<-persontime_benefit_week_BC[,-c(6:14)]

nameoutput<-paste0("D4_IR_benefit_week_BC",suffix[[subpop]])
...
#D4_IR_benefit_fup_BC<-persontime_benefit_year_BC[,-c(6:14)]
nameoutput<-paste0("D4_IR_benefit_fup_BC",suffix[[subpop]])
...
nameoutput<-paste0("D4_IR_risk_week_BC",suffix[[subpop]])
...
nameoutput<-paste0("D4_IR_risk_fup_BC",suffix[[subpop]])
...
nameoutput<-paste0("D4_IR_benefit_week_RF",suffix[[subpop]])
...
nameoutput<-paste0("D4_IR_benefit_fup_RF",suffix[[subpop]])
...
nameoutput<-paste0("D4_IR_risk_week_RF",suffix[[subpop]])
...
nameoutput<-paste0("D4_IR_risk_fup_RF",suffix[[subpop]])
...
nameoutput<-paste0("D4_persontime_ALL_OUTCOMES",suffix[[subpop]])
